...
class Calculator:
    def __init__ (self, master):
        ...
        Button(width=11, height=4, text='Choose Color', relief='flat', bg='white', command=self.choose_color).place(x=270, y=0)
    def choose_color(self):
        color = colorchooser.askcolor()[1]  # Returns a tuple (RGB value, hexadecimal value)
